...
local function makeMenus()
	spawnmenu.AddToolMenuOption( "Base War Settings", "Base War Admin Settings", "Base War Admin Settings", "Prop Protect Admin Settings", "", "", FPP.AdminMenu)
	spawnmenu.AddToolMenuOption( "Base War Settings", "Base War Settings", "Base War Settings", "Prop Protect Buddies", "", "", FPP.BuddiesMenu)
end
