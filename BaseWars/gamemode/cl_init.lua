...
struc.text = "Block-Smash BaseWars" -- Text
...
function MsgTestFactory( msg )
	...
	local ybutton = {}
	_G["PickFunc1"] = function( msg )
		LocalPlayer():ConCommand( "setgunfactoryweapon " .. vault .. " glock18\n" );
	end
	_G["PickFunc2"] = function( msg )
		LocalPlayer():ConCommand( "setgunfactoryweapon " .. vault .. " deagle\n" );
	end
	_G["PickFunc3"] = function( msg )
		LocalPlayer():ConCommand( "setgunfactoryweapon " .. vault .. " m4a1\n" );
	end
	_G["PickFunc4"] = function( msg )
		LocalPlayer():ConCommand( "setgunfactoryweapon " .. vault .. " para\n" );
	end
	_G["PickFunc5"] = function (msg)
		LocalPlayer():ConCommand( "setgunfactoryweapon " .. vault .. " resetbutton\n" );
	end
	_G["PickFunc6"] = function (msg)
		LocalPlayer():ConCommand( "setgunfactoryweapon " .. vault .. " mac10\n" );
	end
	if !cancelmode then
	ybutton[1] = vgui.Create( "Button" );
	ybutton[1]:SetParent( panel );
...
usermessage.Hook( "testgunfactorygui", MsgTestFactory );
...
usermessage.Hook( "testgunfactoryget", MsgTestFactoryGet );
