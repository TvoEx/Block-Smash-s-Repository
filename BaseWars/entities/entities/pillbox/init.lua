...
function ENT:Touch(gun)
	if ((gun:GetClass()=="item_adrenaline" || gun:GetClass()=="item_armorpiercer" || gun:GetClass()=="item_leech" || gun:GetClass()=="item_doublejump" || gun:GetClass()=="item_shockwave" || gun:GetClass()=="item_doubletap" || gun:GetClass()=="item_magicbullet" || gun:GetClass()=="item_knockback" || gun:GetClass()=="item_uberdrug" || gun:GetClass()=="item_superdrugweapmod" || gun:GetClass()=="item_superdrugdefense" || gun:GetClass()=="item_superdrugoffense" || gun:GetClass()=="item_superdrug" || gun:GetClass()=="item_regen" || gun:GetClass()=="item_steroid" || gun:GetClass()=="item_painkiller" || gun:GetClass()=="item_amp" || gun:GetClass()=="item_armor" || gun:GetClass()=="item_buyhealth" || gun:GetClass()=="item_antidote" || gun:GetClass()=="item_helmet" || gun:GetClass()=="item_reflect" || gun:GetClass()=="item_focus" || gun:GetClass()=="item_random" || gun:GetClass()=="item_drug" || gun:GetClass()=="item_booze" || gun:GetClass()=="item_food" || gun:GetClass()=="item_scanner" || gun:GetClass()=="item_toolkit") && table.Count(self.Guns)<20 && gun:GetTime()<CurTime()-5) then
